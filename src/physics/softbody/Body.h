...
#include "physics/softbody/BrokenConnection.h"
#include "physics/softbody/Cell.h"
#include "physics/softbody/LatticeLocation.h"
#include "physics/softbody/LatticePointAndCost.h"
#include "physics/softbody/Particle.h"
namespace aly {
	namespace softbody {
		class Body;
		class Particle;
